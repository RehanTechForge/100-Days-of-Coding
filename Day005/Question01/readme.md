...
This is a simple TypeScript project that prints desires to own different modes of transportation to the console.
...
- `app.ts`: The main TypeScript file that contains the code to print desires to own different modes of transportation.
