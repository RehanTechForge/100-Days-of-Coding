...
This is a simple TypeScript project that demonstrates string manipulation with `trim()`.
...
- `app.ts`: The main TypeScript file that contains the string manipulation code using `trim()`.
