...
This is a simple TypeScript project that prints personalized greetings to friends to the console.
...
- `app.ts`: The main TypeScript file that contains the code to print personalized greetings to friends.
