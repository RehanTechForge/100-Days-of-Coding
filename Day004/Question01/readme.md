...
This is a simple TypeScript project that prints a personal message to the console.
...
2. **Run the compiled JavaScript**
    ...
    ```
    Hello Rehan, would you like to learn some TypeScript today?
    ```

## Project Structure

- `app.ts`: The main TypeScript file that contains the code to print a personal message.
