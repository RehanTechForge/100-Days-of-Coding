...
This is a simple TypeScript project that prints names of friends to the console.
...
- `app.ts`: The main TypeScript file that contains the code to print names of friends.
